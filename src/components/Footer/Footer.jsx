...
const socialLinks = [
  {
    name:'Behance', href:'#',
    icon:<svg viewBox="0 0 24 24" fill="currentColor" width="17" height="17"><path d="M22 7h-7V5h7v2zm1.726 10c-.442 1.297-2.029 3-5.101 3-3.074 0-5.564-1.729-5.564-5.675 0-3.91 2.325-5.92 5.466-5.92 3.082 0 4.964 1.782 5.375 4.426.078.506.109 1.188.095 2.14H15.97c.13 3.211 3.483 3.312 4.588 2.029h3.168zm-7.686-4h4.965c-.105-1.547-1.136-2.219-2.477-2.219-1.466 0-2.277.768-2.488 2.219zm-9.574 6.988H0V5.021h6.953c5.476.081 5.58 5.444 2.72 6.906 3.461 1.26 3.577 8.061-3.207 8.061zm-3.466-8.988h3.584c2.508 0 2.906-3-.312-3H3v3zm3.391 3h-3.39v3.016h3.341c3.055 0 2.868-3.016.049-3.016z"/></svg>,
  },
  {
    name:'Dribbble', href:'#',
    icon:<svg viewBox="0 0 24 24" fill="currentColor" width="17" height="17"><path d="M12 24C5.385 24 0 18.615 0 12S5.385 0 12 0s12 5.385 12 12-5.385 12-12 12zm10.12-10.358c-.35-.11-3.17-.953-6.384-.438 1.34 3.684 1.887 6.684 1.992 7.308 2.3-1.555 3.936-4.02 4.395-6.87zm-6.115 7.808c-.153-.9-.75-4.032-2.19-7.77l-.066.02c-5.79 2.015-7.86 6.025-8.048 6.39 1.73 1.35 3.92 2.166 6.298 2.166 1.42 0 2.77-.29 4.005-.806zm-9.88-2.895c.239-.39 3.117-5.206 8.292-6.83.132-.045.266-.084.399-.12-.239-.557-.503-1.105-.78-1.646-4.818 1.485-9.49 1.425-9.922 1.408a10.142 10.142 0 0 0-.012.99c0 2.34.71 4.51 1.923 6.198zm-2.065-8.138c.438.012 4.422.03 8.95-1.172-1.603-2.85-3.33-5.248-3.588-5.612a10.22 10.22 0 0 0-5.362 6.784zm8.212-7.968c.27.375 2.02 2.77 3.612 5.672 3.438-1.288 4.898-3.24 5.067-3.472A10.133 10.133 0 0 0 12.272 2.45zm9.387 5.688c-.2.26-1.818 2.383-5.418 3.858.225.463.438.932.637 1.407.07.17.14.34.207.513 3.396-.43 6.77.258 7.1.332-.012-2.205-.638-4.266-1.726-6.11z"/></svg>,
  },
  {
    name:'Instagram', href:'#',
